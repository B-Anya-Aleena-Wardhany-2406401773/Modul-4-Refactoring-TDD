...
class CreateProductFunctionalTest {
    ...
    void createProduct(ChromeDriver driver) throws Exception {
        driver.get(baseUrl + "/product/create");
        driver.findElement(By.id("nameInput")).sendKeys("Sampo Anya");
    ...
    void createMultipleProduct(ChromeDriver driver) throws Exception {
        driver.get(baseUrl + "/product/create");
        driver.findElement(By.id("nameInput")).sendKeys("Sampo Aleena");
        ...
        driver.get(baseUrl + "/product/create");
        driver.findElement(By.id("nameInput")).sendKeys("Sampo Wardhany");
        ...
        assertEquals("Sampo Aleena", driver.findElement(By.xpath("//tbody/tr[1]/td[1]")).getText());
        assertEquals("1", driver.findElement(By.xpath("//tbody/tr[1]/td[2]")).getText());
        assertEquals("Sampo Wardhany", driver.findElement(By.xpath("//tbody/tr[2]/td[1]")).getText());
